import useMenuFull from "../../../hooks/site/useMenuFull";

const MenuFull = () => {
  const { isMobile, isHomePage, productsMenu, productsBurgers } = useMenuFull();
  ...
  return (
    <div className="mt-24 max-w-7xl mx-auto">
      ...
      {renderSection("MENU", productsMenu)}
      {renderSection("MAIN BURGERS", productsBurgers)}
    </div>
  );
};
